...
import 'package:awii/pages/chatPage/chat_page.dart';
...
//create icon
  Future<BitmapDescriptor> getCustomIcon(GlobalKey iconKeys) async {
    Future<Uint8List> capturePng(GlobalKey iconKeys) async {
      dynamic pngBytes;
      try {
  ...
  addDropMarker() async {
    for (var i = 1; i < addressList.length; i++) {
      BitmapDescriptor testIcon = await getCustomIcon(iconDropKeys[i + 1]);
    ...
    if (widget.type != 1) {
      ...
      if (userRequestData.isNotEmpty) {
        ...
        if (addressList
                ...
                addressList
                    .firstWhere((element) =>
                        element.id == addressList.length.toString())
                    .latlng
                    .latitude &&
            addressList
                    .firstWhere((element) => element.id == '1')
          ...
          bound = LatLngBounds(
              southwest: addressList
                  .firstWhere(
                      (element) => element.id == addressList.length.toString())
                  .latlng,
          ...
          bound = LatLngBounds(
              southwest:
                  addressList.firstWhere((element) => element.id == '1').latlng,
              northeast: addressList
                  .firstWhere(
                      (element) => element.id == addressList.length.toString())
                  .latlng);
                          ...
                          if (event.data!.snapshot.value != null) {
                            if (userRequestData['accepted_at'] == null) {
                              ...
                              if (snapshots != null) {
                                ...
                                //     print('format is ' + driversData.toString()[0]);
                                // if (driversData != []) {
                                  // ignore: avoid_function_literals_in_foreach_calls
                        ...
                        return StreamBuilder<DatabaseEvent>(
                            stream: (userRequestData['driverDetail'] != null &&
                                ...
                                ? FirebaseDatabase.instance
                                    .ref('drivers/${userRequestData['driverDetail']['data']
                                                ['id']}')
                                    .onValue
                                : null,
                            builder:
                                    ...
                                    if (snapshots != null) {
                                      ...
                                      if (driverData != {}) {
                                        if (myMarker
                                            ...
                                            .isEmpty) {
                                          myMarker.add(Marker(
                                            markerId: MarkerId('car${driverData['id']}'),
                                            rotation: (myBearings[
                                                        driverData['id']
                                                            .toString()] !=
                                                    null)
                                                                                      ...
                                                                                      StreamBuilder<DatabaseEvent>(
                                                                                          ...
                                                                                          builder: (context, AsyncSnapshot event) {
                                                                                            ...
                                                                                            return InkWell(
                                                                                              onTap: () {
                                                                                                setState(() {
                                                                                                  vehicleIconType = etaDetails[i]['id'].toString();
                                                                                                  selectedGoodsId = '';
                                                                                                  choosenVehicle = i;
                                                                                                });
                                                                                              },
                                                                                              child: Container(
                                                                                                ...
                                                                                                margin: EdgeInsets.only(top: media.width * 0.025, bottom: media.width * 0.025, right: media.width * 0.025),
                                                                                                      ...
                                                                                                      children: [
                                                                                                        ...
                                                                                                        (minutes[etaDetails[i]['type_id']] != null && minutes[etaDetails[i]['type_id']] != '')
                                                                                                            ? Text(
                                                                                                                ...
                                                                                                                style: TextStyle(fontSize: media.width * twelve, color: textColor.withOpacity(0.3)),
                                                                                                              )
                                                                                                            : Text(
                                                                                                                '- -',
                                                                                                                style: TextStyle(fontSize: media.width * twelve, color: textColor.withOpacity(0.3)),
                                                                                                      ...
                                                                                                      children: [
                                                                                                        Row(
                                                                                                          children: [
                                                                                                            Text(
                                                                                                              etaDetails[i]['name'],
                                                                                                              style: TextStyle(fontSize: media.width * twelve),
                                                                                                            ),
                                                                                                            SizedBox(
                                                                                                        ...
                                                                                                        Text(
                                                                                                          ...
                                                                                                          style: (etaDetails[i]['has_discount'] != true) ? TextStyle(fontSize: media.width * twelve, color: textColor, fontWeight: FontWeight.w600) : TextStyle(fontSize: media.width * twelve, color: textColor, fontWeight: FontWeight.w600, decoration: TextDecoration.lineThrough),
                                                                                                        ),
                                                                                                        (etaDetails[i]['has_discount'] == true)
                                                                                                            ? Container(
                                                                                                                ...
                                                                                                                child: Text(
                                                                                                                  ...
                                                                                                                  style: TextStyle(fontSize: media.width * twelve, color: textColor, fontWeight: FontWeight.w600),
                                                                                                                ),
                                                                                                              )
                                                                                                            : Container()
                                                                                                      ],
                                                                                          ...
                                                                                          Container(
                                                                                            ...
                                                                                            child: InkWell(
                                                                                              ...
                                                                                              child: Text(
                                                                                                ...
                                                                                                style: TextStyle(fontSize: media.width * sixteen, fontWeight: FontWeight.w600, color: (rentalChoosenOption == i) ? Colors.white : Colors.black),
                                                                                              ),
                                                                                            ),
                                                                                          ));
                                                                                    })
                                                                                            ...
                                                                                            StreamBuilder<DatabaseEvent>(
                                                                                                ...
                                                                                                builder: (context, AsyncSnapshot event) {
                                                                                                  ...
                                                                                                  return InkWell(
                                                                                                    onTap: () {
                                                                                                      setState(() {
                                                                                                        vehicleIconType = rentalOption[i]['id'].toString();
                                                                                                        selectedGoodsId = '';
                                                                                                        choosenVehicle = i;
                                                                                                      });
                                                                                                    },
                                                                                                          ...
                                                                                                          Column(
                                                                                                            ...
                                                                                                            children: [
                                                                                                              ...
                                                                                                              Text(
                                                                                                                ...
                                                                                                                style: (rentalOption[i]['has_discount'] != true) ? TextStyle(fontSize: media.width * twelve, color: textColor, fontWeight: FontWeight.w600) : TextStyle(fontSize: media.width * twelve, color: textColor, fontWeight: FontWeight.w600, decoration: TextDecoration.lineThrough),
                                                                                                              ),
                                                            ...
                                                            children: [
                                                              SizedBox(
                                                                width: media
                                                                        .width *
                                                                    0.06,
                                                                child: (etaDetails[choosenVehicle]['payment_type'].toString().split(',').toList()[
                                                                            payingVia] ==
                                                                        'cash')
                                                                    ? Image
                                                                        .asset(
                                                                                          ...
                                                                                          Column(
                                                                                            ...
                                                                                            children: [
                                                                                              Text(
                                                                                                ...
                                                                                                style: TextStyle(fontSize: media.width * fourteen, fontWeight: FontWeight.w600),
                                                                                              ),
                                                                                              Text(
                                                                    ...
                                                                    child: (promoStatus ==
                                                                        ...
                                                                        ? TextField(
                                                                            ...
                                                                            decoration: InputDecoration(
                                                                                ...
                                                                                hintStyle: TextStyle(fontSize: media.width * twelve, color: hintColor)),
                                                                          )
                                                                        : (promoStatus ==
                                                                                1)
                                                                            ? Container(
                                                                                ...
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                    Column(
                                                                                      children: [
                                                                                        Text(promoKey.text, style: TextStyle(fontSize: media.width * ten, color: const Color(0xff319900))),
                                                                                        Text(languages[choosenLanguage]['text_promoaccepted'], style: TextStyle(fontSize: media.width * ten, color: const Color(0xff319900))),
                                                                                      ],
                                                                                    ),
                                                                                    InkWell(
                                                                                      onTap: () async {
                                                                                      ...
                                                                                      child: Text(languages[choosenLanguage]['text_remove'], style: TextStyle(fontSize: media.width * twelve, color: const Color(0xff319900))),
                                                                                    )
                                                                                  ],
                                                                                ),
                                                                              )
                                                                            : (promoStatus == 2)
                                                                                ? Container(
                                                                                    ...
                                                                                    child: Row(
                                                                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                                      children: [
                                                                                        Text(promoKey.text, style: TextStyle(fontSize: media.width * twelve, color: const Color(0xffFF0000))),
                                                                                        InkWell(
                                                                                          onTap: () {
                                                                                            setState(() {
                                                                                              promoStatus = null;
                                                                                          ...
                                                                                          child: Text(languages[choosenLanguage]['text_remove'], style: TextStyle(fontSize: media.width * twelve, color: const Color(0xffFF0000))),
                                                                                        )
                                                                                      ],
                                                                                    ),
                                                                                  )
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            style:
                                                                                TextStyle(fontSize: media.width * twelve, color: (chatList.where((element) => element['from_type'] == 2 && element['seen'] == 0).isEmpty) ? hintColor : const Color(0xffFF0000)),
                                                                          ),
                                                                        ),
                                                                        (chatList.where((element) => element['from_type'] == 2 && element['seen'] == 0).isEmpty)
                                                                            ? RotatedBox(
                                                                            ...
                                                                            : Text(
                                                                                ...
                                                                                style: TextStyle(fontSize: media.width * twelve, color: const Color(0xffFF0000)),
                                                                              )
                                                                      ],
                                                                    ),
                                                                  ),
                                                                                            ...
                                                                                            child: Row(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                SizedBox(
                                                                                                  ...
                                                                                                  child: Text(
                                                                                                    tripStops[i]['address'],
                                                                                                    style: TextStyle(fontSize: media.width * twelve, color: textColor),
                                                                                                    maxLines: 1,
                                                                                ...
                                                                                child: Column(
                                                                                  children: [
                                                                                    ...
                                                                                    Text(
                                                                                      ...
                                                                                      style: TextStyle(fontSize: media.width * ten, fontWeight: FontWeight.w600, color: textColor),
                                                                                    )
                                                                                  ],
                                                                                ),
                                                                              )
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              ...
                                                                              style: TextStyle(fontSize: media.width * sixteen, color: textColor, fontWeight: FontWeight.w600),
                                                                            ),
                                                                                          ...
                                                                                          Column(
                                                                                            ...
                                                                                            children: [
                                                                                              SizedBox(
                                                                                                ...
                                                                                                child: Text(
                                                                                                  sosData[i]['name'],
                                                                                                  style: TextStyle(fontSize: media.width * fourteen, color: textColor, fontWeight: FontWeight.w600),
                                                                                                ),
                                                                                              ),
                                                                                              SizedBox(
                                                                                                height: media.width * 0.01,
                                                ...
                                                Container(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      Container(width: 100,color: Colors.red, height: 5),
                                                      SizedBox(
                                                        height:
                                                        media.width * 0.03,
                                                      ),
